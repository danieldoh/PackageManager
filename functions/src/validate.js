...
function validation(token) {
    return __awaiter(this, void 0, void 0, function () {
        var db, tokenRef, docUser, defaultRef, docDefault, docData, access, Username, docData, access, Username;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    db = (0, firestore_1.getFirestore)(admin.apps[0]);
                    tokenRef = db.collection("token").doc(token);
                    return [4 /*yield*/, tokenRef.get()];
                case 1:
                    docUser = _a.sent();
                    defaultRef = db.collection("Default Admin").doc(token);
                    return [4 /*yield*/, defaultRef.get()];
                case 2:
                    docDefault = _a.sent();
                    if (docUser.exists) {
                        console.log("validate: found the user");
                        docData = docUser.data();
                        access = docData === null || docData === void 0 ? void 0 : docData["Admin"];
                        Username = docData === null || docData === void 0 ? void 0 : docData["Username"];
                        if (access == true) {
                            console.log("validate: isAdmin");
                            return [2 /*return*/, [true, Username]];
                        }
                        else {
